...
delete tutorials or tutorial series 
*/ 
...
export default (app: Router) => {
  ...
  async (req: Request, res: Response) => {
    ...
    */
    ...
    const userConfigServiceInstance = Container.get(UserConfigService)
    try {
      ...
      const data = await userConfigServiceInstance.editUserInfo(userId, options, req.file)
